    ...
    <Reveal delay={0}>
      <div
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = `0 16px 48px ${project.color}22, 0 4px 16px rgba(0,0,0,0.4)`;
          e.currentTarget.style.borderColor = `${project.color}55`;
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = '';
          e.currentTarget.style.boxShadow = '';
          e.currentTarget.style.borderColor = 'rgba(42,58,80,0.5)';
        }}
      >
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--red)', width: 30, height: 30,
              cursor: 'pointer',
