...
export const SKILLS = [
  {
    ...
    tags: ["React", "Next.js", "Redux Toolkit", "Redux-Saga", "Context API"],
  },
  {
    id: "BRAVO",
    level: 92,
  ...
  },
  {
    ...
    tags: ["Module Federation", "Design Systems", "Component Libraries", "Internal NPM"],
  },
  {
    id: "DELTA",
    level: 87,
    name: "UI & Performance",
    tags: ["Material UI", "Tailwind CSS", "Accessibility", "Lighthouse"],
  },
  {
    id: "ECHO",
    level: 85,
    name: "Cloud & DevOps",
    tags: ["AWS Amplify", "S3", "CloudFront", "CodeArtifact", "CI/CD"],
  },
  {
    id: "FOXTROT",
    level: 83,
    name: "Testing & Quality",
    tags: ["Jest", "RTL", "Storybook", "SonarQube", "Snyk", "Husky"],
  },
];
...
export const EXPERIENCE = [
  {
    ...
    color: "var(--red)",
    achievements: [
      "Took ATOM Portal from zero to a working 4-app micro-frontend setup — React, Next.js, TypeScript, Webpack Module Federation — covering 10+ insurance products across Agency, Alternate, and Banca channels. It now handles 600K+ agents daily and reduced deployment conflicts by 60% while module onboarding sped up by ~40%.",
      "Eliminated ~45% of repetitive sprint back-and-forth by introducing a JSON config layer that lets product teams spin up new insurance workflows without raising a frontend ticket.",
      "Cut cross-app integration issues from 8–10 per sprint to 2–3 by initiating upfront API contract sessions with backend, product, and ops before builds started.",
      "Saved 30% of UI build time across 3+ products by delivering a shared Material UI component system; it now underpins 5+ apps collectively serving 5M+ users across US markets.",
      "Reduced production defects by 30% and improved PR throughput by rolling out SonarQube, Snyk, and Husky pre-commit hooks for 10+ developers.",
      "Reduced new feature scaffolding time by ~40% by building a 40+ component Storybook library after identifying duplicate UI work across parallel applications.",
      "Built GrowPro marketing platform used by 600K+ agents with a drag-and-drop poster editor, dynamic templates, and HTML-to-PDF export via Next.js API routes.",
      "Owned @star-ui/atom-claims-ui — a shared internal NPM package for claims intake, review, query management, and settlement workflows; shipped 3 major releases with zero breaking changes through Rollup ES modules and AWS CodeArtifact distribution.",
    ],
    tech: [
      "React",
      "Next.js",
  ...
  },
  {
    ...
    color: "var(--cyan)",
    achievements: [
      "Eased bug reports by 20% and improved workflow speed by 10–15% by building dashboards and workflow UIs across 5+ clinical modules for BSWHealth (200+ DAU) in React, TypeScript, and Redux-Saga.",
      "Brought table render time down by 40% on 10K+-row datasets through row virtualisation and optimized rendering.",
      "Delivered a 15-component Storybook library to standardize UI and accelerate delivery by 35%.",
      "Shaved 30% off page load by wiring AWS Amplify CI/CD with CloudFront caching and optimized asset delivery.",
    ],
    tech: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    color: "var(--gold)",
    achievements: [
      "Reduced initial bundle size by ~35% and brought page loads under 2s for 5M+ monthly visitors by leading bundle optimisation, code splitting, and lazy loading on NetworkedLive.",
      "Completed a full platform migration for 100K+ users — rebuilt 4 auth flows, achieved a 78% re-registration rate, and integrated Stripe end-to-end with zero data loss.",
      "Built reusable Material UI systems for forms, dialogs, tables, and complex input components.",
      "Implemented authentication and account management flows including email/password, Facebook OAuth, email verification, and password reset.",
    ],
    tech: [
      "React",
      "Redux",
  ...
  },
  {
    ...
    achievements: [
      "Built QVision — a real-time QA monitoring dashboard used by 700+ engineers across 10+ CI test suites, with analytics, trend reporting, and Jira PI automation.",
      ...
      "Developed frontend systems using React, Redux, and Spring Boot for internal apps and operational dashboards.",
